        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <div className="hotel-card-grid">
            {fetchedHotels.map((hotel, i) => {
              ...
              const initial = hotel.name.trim()[0]?.toUpperCase() ?? "H";
              return (
                <button
                  key={hotel.name + i}
                ...
                >
                  <div className="hotel-card-initial">{initial}</div>
                  <div style={{ padding: "10px 12px" }}>
                    <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {hotel.rating && (
                          <div style={{ fontSize: 11, color: "var(--fg-2)", fontFamily: "var(--font-body)", marginBottom: 6 }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            {daysPlaces.map(d => (
              <div key={d.day_number} style={{ marginBottom: 16 }}>
                ...
                <div className="dinner-option-grid">
                    ...
                    return (
                      ...
                      >
                        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                          ...
                          {opt.restaurant_name && (
                            <div style={{ fontFamily: "var(--font-body)", fontWeight: 700, fontSize: 12, color: "var(--fg)", lineHeight: 1.3 }}>
                              {opt.restaurant_name}
                              {opt.rating ? <span style={{ fontWeight: 500, color: "var(--fg-2)" }}> · ★{opt.rating}</span> : null}
                            </div>
                          )}
