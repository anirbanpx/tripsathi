...
function hotelEl(): HTMLDivElement {
  ...
  el.style.cssText = `
    ...
    cursor:pointer;
  `;
  el.innerHTML = `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="${PAPER}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4v16"/><path d="M2 8h18a2 2 0 0 1 2 2v10"/><path d="M2 17h20"/><path d="M6 8v9"/></svg>`;
  return el;
}
  ...
  if (!TOKEN || TOKEN === "your_mapbox_token_here") {
    return (
      <div style={{
        ...
        <div style={{ color: "var(--fg-3)", lineHeight: 0 }}>
